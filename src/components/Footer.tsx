    ...
    <footer className="relative py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <span>workwithalanshoji@gmail.com</span>
        </a>
        
        <div className="flex items-center justify-center gap-6 sm:gap-8 mb-12 sm:mb-14 md:mb-16">
          <a
            href="https://www.instagram.com/alan_shoji_?igsh=YnFjMzBwcDZ3amw%3D&utm_source=qr"
            target="_blank"
          ...
          <a
            href="https://wa.me/918943442567" // Replace with your number
            target="_blank"
            rel="noopener noreferrer"
            className="text-white hover:text-white/80 transition-colors duration-300"
            aria-label="WhatsApp"
        ...
        <p className="text-xs sm:text-sm text-white/70">
          © 2026 Alan Shoji. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
